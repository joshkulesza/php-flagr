...
class EvaluationApi
{
     ...
     *
     * @param  \Swagger\Client\Flagr\EvalContext $body evalution context (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Flagr\EvalResult
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Flagr\EvalResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Flagr\EvalResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Flagr\EvalResult',
     ...
     *
     * @param  \Swagger\Client\Flagr\EvaluationBatchRequest $body evalution batch request (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Flagr\EvaluationBatchResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Flagr\EvaluationBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationBatchWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Flagr\EvaluationBatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Flagr\EvaluationBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
